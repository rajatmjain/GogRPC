...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x17, 0x2e,
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 1: greet_service.GreetService.SayHelloClientStreaming:input_type -> greet_service.NameList
	3, // 2: greet_service.GreetService.SayHelloServerStreaming:input_type -> greet_service.HelloRequest
	...
	1, // 5: greet_service.GreetService.SayHelloClientStreaming:output_type -> greet_service.HelloResponse
	4, // 6: greet_service.GreetService.SayHelloServerStreaming:output_type -> greet_service.MessageList
